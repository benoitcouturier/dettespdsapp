...
<body style="background-color: #f9f6f6">
	...
	<div class="container"
		...
		<div class="row">
			<div class="col col-lg-12">
				...
				<div class="form-group">
					<label for="wm_distance">Distance min(km)</label> <input
						type="text" class="form-control" id="wm_distance_min"
						placeholder="0">
				</div>

				<div class="form-group">
					<label for="wm_distance">Distance max(km)</label> <input
						type="text" class="form-control" id="wm_distance_max"
						placeholder="500">
				</div>

				<div class="form-group">
					<label for="wm_distance">Délai de livraison min</label> <input
						type="text" class="form-control" id="wm_livraison_min"
						placeholder="3">
				</div>

				<div class="form-group">
					<label for="wm_distance">Délai de livraison max</label> <input
	...
	<div class="container">
		<div class="row">
			<div class="col col-lg-12">
				<h3>Rechercher un mode de retrait</h3>
			</div>
		</div>
	</div>
	...
	<div class="container"
		...
		<div class="row">
			<div class="col col-lg-12">
				...
				<button onclick="rechercheTarif()" class="btn btn-primary">Rechercher</button>
	...
	<div class="container">
		<div class="row">
			<div class="col col-lg-12">
				<h3>Modes de retrait recherché</h3>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col col-lg-12">
				<table class="table table-hover">
					...
					<tbody>
						<c:forEach items="${requestScope['wmsByNames']}" var="i">
							<tr>
...
<script>
	function formulaireTarif() {
		...
		obj.wm_livraison_max = wm_livraison_maxs;
	...
	function rechercheTarif() {
		console.log('Envoi du formulaire');

		var wm_name = $('#wm_names').val();


		var obj = new Object();
		obj.wm_names = wm_names;
		...
		$.ajax({
			...
			// url API
			url : 'http://192.168.20.3:8080/ApiRest/RestGT/WM/find',
